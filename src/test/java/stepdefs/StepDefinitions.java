...
//    }
    ...
    public void validateColor(String backgroundColor){
        ...
        WebElement navBar = theWebDriver.findElement(By.xpath("//div[@class='navbar-inner']"));
        color = theWebDriver.findElement(By.xpath("//div[@class='navbar-inner']")).getCssValue("background-image");
        LOG.debug(color);

        WebElement profile = theWebDriver.findElement(By.xpath("//a[@class='dropdown-toggle']"));
        profile.click();
        wait = new FluentWait<WebDriver>(theWebDriver);
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[contains(text(),'My')]")));
        profile = theWebDriver.findElement(By.xpath("//a[contains(text(),'My')]"));
        profile.click();
